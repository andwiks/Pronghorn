...
<div id="mobile_banner" style="position: absolute; top: -1px; width: 100%; background-color: #D3D3D3; z-index: 101; text-align: center; padding-bottom: 10px;">
  <table style="text-align: center; width: 100%">
	<tr>
	  <td width="20%"><img width="70px" src="<?php if (isset($content['image_path'])) print $content['image_path'] ?>" /></td>
