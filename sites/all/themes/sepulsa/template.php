...
function sepulsa_form_alter(&$form, &$form_state, $form_id) {
  ...
  if ($form_id == "sepulsa_phone_form") {
    ...
    elseif (isset($form['commerce_payment']['payment_details']['bank_details'])) {
      ...
      $form['commerce_payment']['payment_details']['bank_details']['#prefix'] = '<p></p><p><strong id="banktransfernotif">' . t('For Bank Transfer Payment Method, there will be additional fee of Rp XXX') . '</strong><br><strong>' . t('Please make payment to:') . '</strong>';
